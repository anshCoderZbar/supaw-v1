    ...
    >
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
          <ul
            className={`navbar-nav ms-auto gap-lg-4 align-items-center ${styles.o_s_s}`}
          >
            <li className="nav-item fw-semibold active">
              <a className="nav-link text-dark" href="#pet-supplies">
                Pet Supplies
              </a>
            </li>
            <li className="nav-item fw-semibold">
              <a className="nav-link text-dark" href="#veterinary">
                Veterinary
              </a>
            </li>
            <li className="nav-item fw-semibold">
